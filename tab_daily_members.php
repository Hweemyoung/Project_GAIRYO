...
class DailyMembersHandler
{
    ...
    public function __construct($id_user, $dbh, $arrayHparams)
    {
    ...
    private function setArrayDateObjects()
    {
        ...
        $arrayShiftObjectsByDate = $stmt->fetchAll(PDO::FETCH_GROUP | PDO::FETCH_CLASS, 'ShiftObject', [$this->arrayMemberObjectsByIdUser]);
